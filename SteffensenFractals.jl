...
for i = 1:runs
    ...
    save("Steffensen Fractals\\steffensenfractal$i.png", colorview(RGB, picture(pictureArray[:,:,i]) / 255))
end

#save("steffensenfractal.png", colorview(RGB, picture(pictureArray[:,:,runs]) / 255))
